...
int main(void) {
  ...
  while(!glfwWindowShouldClose(window)) {
    ...
    /* Second container */
    double timeScaler = sin(glfwGetTime());
    timeScaler = timeScaler < 0 ? -timeScaler : timeScaler;
    vec3 scaleVec = { timeScaler, timeScaler, timeScaler };
    glm_translate_make(trans, transVec2);
